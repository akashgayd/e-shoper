        ...
        <div className="min-h-screen bg-gray-100 py-6">
            <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
                <div className="md:flex">
                            ...
                            <div className="flex overflow-x-auto p-2 gap-2 bg-gray-50">
                                {product?.images?.map((img, index) => (
                                    <img
                                        ...
                                        className={`h-16 w-16 object-cover cursor-pointer rounded-md transition-shadow duration-300 ${activeImageIndex === index ? 'shadow-lg shadow-blue-300 border-2 border-blue-400' : 'border border-gray-200 hover:shadow-md'}`}
                    ...
                    <div className="md:w-1/2 w-full p-8"> {/* Responsive width */}

                        <div className="flex items-center mb-4">
                            <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full font-semibold mr-2">{product?.category}</span>
                        ...
                        <div className="mb-6">
                            <div className="flex items-center">
                                <span className="text-4xl font-bold text-blue-700 mr-3">${discountedPrice.toFixed(2)}</span>
                            ...
                            <p className="text-green-600 text-sm mt-1">In Stock: {product?.stock} units</p>
                        </div>
                        ...
                        <div className="flex items-center mb-7">
                            ...
                            <div className="flex items-center border border-gray-300 rounded-md overflow-hidden">
                                <button
                                    onClick={() => setQuantity(prevQuantity => Math.max(1, prevQuantity - 1))} //Simplified quantity decrement
                                ...
                                <input type="number" id="quantity" name="quantity" value={quantity} onChange={handleQuantityChange}
                                    min="1" className="w-20 py-2 text-center border-l border-r border-gray-300 focus:outline-none"
                                />
                                <button
                                    onClick={() => setQuantity(prevQuantity => prevQuantity + 1)} // Simplified quantity increment
                                    className="px-4 py-2 bg-gray-50 hover:bg-gray-200 transition-colors duration-200 text-gray-700"
                                >
                                    +
                                </button>
